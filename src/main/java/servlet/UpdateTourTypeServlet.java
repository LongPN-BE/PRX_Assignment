 ...
 * @author phien
 */
@WebServlet(name = "UpdateTourTypeServlet", urlPatterns = {"/UpdateTourTypeServlet"})
public class UpdateTourTypeServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            TourType tourType = new TourType(id, name, description);
        } catch (Exception e) {
