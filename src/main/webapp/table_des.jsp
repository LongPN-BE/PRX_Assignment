                            ...
                            <c:forEach var="item" items="${listDes}" varStatus="counter">
                                <tr>
                                    ...
                                    <c:if test="${user.rolename.equals('supermod') || user.rolename.equals('admin') || user.rolename.equals('supermod')}" >
                                        <td><a href="UpdateServlet?tourDestinationID=${item.id}" class="genric-btn warning radius">Edit</a></td>
                                    </c:if>
                                    <c:if test="${user.rolename.equals('supermod') || user.rolename.equals('admin') }">
                                        <td><a href="DeleteServlet?tourDestinationID=${item.id}" class="genric-btn danger radius">Delete</a></td>
                                    </c:if>
                                </tr>
                            </c:forEach>
                        </tbody>
